...
app.get('/usuario/obtener', (req, res) => {
...
app.put('/usuario/actualizar/:id', (req, res) => {
    ...
    let body = _.pick(req.body, ['nombre', 'apellidoMaterno', 'estado', 'direccion', 'apellidoPaterno', 'colonia']); //FILTRAR del body, on el pick seleccionar los campos que interesan del body 
